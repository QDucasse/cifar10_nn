...
* For downloading and installing the source code of the project:
  ...
  ```bash
    ...
    $ git clone https://github.com/QDucasse/cifar10_nn
...
```bash
  $ python cifar10_nn/tests/chosentest.py
  $ pytest
```
...
[package]:https://github.com/QDucasse/cifar10_nn/tree/master/cifar10_nn/package
